package io.github.kleitonmarques.libraryapi.controller.common;

import io.github.kleitonmarques.libraryapi.controller.dto.ErroCampo;
import io.github.kleitonmarques.libraryapi.controller.dto.ErroResposta;
import io.github.kleitonmarques.libraryapi.exceptions.CampoInvalidoException;
...
public class GlobalExceptionHandler {
    ...
    public ErroResposta handleErrosNaoTratados(RuntimeException e) {
        return new ErroResposta(HttpStatus.INTERNAL_SERVER_ERROR.value(),
                "Occoreu um erro inesperado. Entre em contato com a administração.", List.of());
    }
}
