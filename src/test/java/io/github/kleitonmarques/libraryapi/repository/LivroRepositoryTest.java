...
class LivroRepositoryTest {
   ...
   @Test
    void salvarTest() {
       ...
       Autor autor = autorRepository.findById(UUID.fromString("bc6c9d07-249d-4bf0-b71e-2eed91dca6cb")).orElse(null);
   ...
   void atualizarAutorDoLivro() {
      UUID id = UUID.fromString("f2ccdff9-fd50-43a3-972a-bb63372d7b4d");
      var livroParaAtualizar = repository.findById(id).orElse(null);

      UUID idAutor = UUID.fromString("0525813a-73ec-45bb-82e9-ab5780c81542");
   ...
   @Test
   void deletarCascade() {
      UUID id = UUID.fromString("a9e303bd-a782-442f-ab7d-95621dac2b38");
      repository.deleteById(id);
   }
   ...
   void buscarLivroTest() {
      UUID id = UUID.fromString("d778b7e0-9c1e-4bc2-867a-ba8b293daf0a");
